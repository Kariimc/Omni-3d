...
| | |
|---|---|
| Repo | `Kariimc/Omni-3d` |
| Namespace | user `Kariimc` |
| Default branch | `claude/dazzling-meitner-i36b3k` |
| Visibility | public |
| Language | TypeScript |
| Files | 118 |
| Last commit | 2026-07-07 - Merge pull request #2 from Kariimc/plan/higgsfield-competitor |
| Branches | 6 |
| Open PRs | 0 |

**Top-level dirs:** `.claude`, `.github`, `data`, `docs`, `public`, `schemas`, `src`, `supabase`, `wargames`

**Root files:** `.env.example`, `.gitignore`, `PROGRESS.md`, `README.md`, `package-lock.json`, `package.json`, `tsconfig.json`

**Existing docs:** `PROGRESS.md`, `README.md`, `docs/ARCHITECTURE.md`, `wargames/README.md`, `docs/plan/HANDOFF.md`, `docs/plan/MASTER_PLAN.md`, `docs/plan/PLAN_REVIEW.md`, `docs/plan/SESSION_HANDOFF.md`, `docs/plan/SITE_SPEC.md`
